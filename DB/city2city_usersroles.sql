...
CREATE TABLE `usersroles` (
  ...
  PRIMARY KEY (`id_user`),
  KEY `FK1tne1qvdekphbeiiujt1phvco` (`role_id`),
  CONSTRAINT `FK1tne1qvdekphbeiiujt1phvco` FOREIGN KEY (`role_id`) REFERENCES `roles` (`id`),
  CONSTRAINT `FKri5nc3l5a6gayu11lkxeux32n` FOREIGN KEY (`id_user`) REFERENCES `users` (`id`)
...
INSERT INTO `usersroles` VALUES (1,1),(3,1),(2,2),(4,2),(11,2);
