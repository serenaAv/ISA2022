/**
 * Test eseguito con Junit relativo alla classe "Link": si occupa di testare
...
public class LinkTest {
    ...
    public static void printName() {
        System.out.println("[Unit test] LinkTest-Avvio");
    }
    @AfterClass
    public static void tearDownClass() {
        System.out.println("[Unit test] LinkTest-Fine");
    }
/**
 ...
 */ 
    ...
    @Property(trials = 50)
    public void testSetDestination(@From(InvalidStringGenerator.class) String invalid, @From(StringGenerator.class) String valid) {
        IllegalArgumentException e1 = null;
        try {
            new Link().setDestination(invalid);
